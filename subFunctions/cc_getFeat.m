...
function [m, b, fv10K] = cc_getFeat(statsMat)
...
set(gcf, 'Position',  [100, -150, 1200, 850])
...
% *uncomment for log base 10 plot with best fit* 
% x2 = log10(x1);
% y2 = log10(y1);
% % figure;
% ax2 = subplot(2,1,2);
...
% *log-log plot with natural logarithm best fit
f2 = figure;
% ax2 = subplot(2,1,2);
% chorLine = plot(x2, y2, 'o','MarkerSize',8, 'MarkerEdgeColor','none','MarkerFaceColor',c1);
chorLine = loglog(x1,y1, 'o','MarkerSize',20, 'MarkerEdgeColor','none','MarkerFaceColor',c1);
% title('Number versus size log-log plot','FontSize',16)
ylabel('Number','fontweight','bold','FontSize',fSize)
xlabel('Area (\mum^2)','fontweight','bold','FontSize',fSize)
ylim([10^0 10^4])
